...
const rules = {
	...
	'consistent-destructuring': createRule(
		consistentDestructuring,
		'consistent-destructuring',
	),
	'consistent-empty-array-spread': createRule(
		consistentEmptyArraySpread,
		'consistent-empty-array-spread',
	),
	'consistent-existence-index-check': createRule(
		consistentExistenceIndexCheck,
		'consistent-existence-index-check',
	),
	'consistent-function-scoping': createRule(
		consistentFunctionScoping,
		'consistent-function-scoping',
	),
	'custom-error-definition': createRule(
	...
	'expiring-todo-comments': createRule(
		expiringTodoComments,
		'expiring-todo-comments',
	),
	'explicit-length-check': createRule(
		explicitLengthCheck,
	...
	'no-abusive-eslint-disable': createRule(
		noAbusiveEslintDisable,
		'no-abusive-eslint-disable',
	),
	'no-accessor-recursion': createRule(
		noAccessorRecursion,
		'no-accessor-recursion',
	),
	'no-anonymous-default-export': createRule(
		noAnonymousDefaultExport,
		'no-anonymous-default-export',
	),
	'no-array-callback-reference': createRule(
		noArrayCallbackReference,
		'no-array-callback-reference',
	),
	'no-array-for-each': createRule(noArrayForEach, 'no-array-for-each'),
	'no-array-method-this-argument': createRule(
	...
	'no-await-in-promise-methods': createRule(
	...
	'no-instanceof-builtins': createRule(
		noInstanceofBuiltins,
		'no-instanceof-builtins',
	),
	'no-invalid-fetch-options': createRule(
		noInvalidFetchOptions,
		'no-invalid-fetch-options',
	),
	'no-invalid-remove-event-listener': createRule(
	...
	'no-single-promise-in-promise-methods': createRule(
	...
	'no-unnecessary-array-splice-count': createRule(
		noUnnecessaryArraySpliceCount,
		'no-unnecessary-array-splice-count',
	),
	'no-unnecessary-await': createRule(
		noUnnecessaryAwait,
		'no-unnecessary-await',
	),
	'no-unnecessary-polyfills': createRule(
	...
	'no-unused-properties': createRule(
		noUnusedProperties,
	...
	'no-useless-length-check': createRule(
		noUselessLengthCheck,
		'no-useless-length-check',
	),
	'no-useless-promise-resolve-reject': createRule(
	...
	'no-useless-undefined': createRule(
		noUselessUndefined,
	...
	'prefer-dom-node-append': createRule(
		preferDomNodeAppend,
		'prefer-dom-node-append',
	),
	'prefer-dom-node-dataset': createRule(
		preferDomNodeDataset,
		'prefer-dom-node-dataset',
	),
	'prefer-dom-node-remove': createRule(
		preferDomNodeRemove,
		'prefer-dom-node-remove',
	),
	'prefer-dom-node-text-content': createRule(
	...
	'prefer-modern-dom-apis': createRule(
		preferModernDomApis,
		'prefer-modern-dom-apis',
	),
	'prefer-modern-math-apis': createRule(
		preferModernMathApis,
		'prefer-modern-math-apis',
	),
	'prefer-module': createRule(preferModule, 'prefer-module'),
	'prefer-native-coercion-functions': createRule(
		preferNativeCoercionFunctions,
		'prefer-native-coercion-functions',
	),
	'prefer-negative-index': createRule(
		preferNegativeIndex,
	...
	'prefer-object-from-entries': createRule(
		preferObjectFromEntries,
		'prefer-object-from-entries',
	),
	'prefer-optional-catch-binding': createRule(
		preferOptionalCatchBinding,
		'prefer-optional-catch-binding',
	),
	'prefer-prototype-methods': createRule(
		preferPrototypeMethods,
		'prefer-prototype-methods',
	),
	'prefer-query-selector': createRule(
		preferQuerySelector,
		'prefer-query-selector',
	),
	'prefer-reflect-apply': createRule(
		preferReflectApply,
	...
	'prefer-string-starts-ends-with': createRule(
		preferStringStartsEndsWith,
		'prefer-string-starts-ends-with',
	),
	'prefer-string-trim-start-end': createRule(
	...
	'prefer-top-level-await': createRule(
		preferTopLevelAwait,
	...
	'require-post-message-target-origin': createRule(
	...
	'text-encoding-identifier-case': createRule(
